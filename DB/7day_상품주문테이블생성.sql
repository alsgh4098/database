...
--------------------------------------------------------
  ...
  CREATE TABLE GOODS 
   ...
   CREATE TABLE USERS 
   (	USER_SEQ NUMBER constraint PK_USERS  primary key, 
	USER_ID VARCHAR2(20) , 
	...
	USER_GUBUN CHAR(1), 
	MGR_SEQ NUMBER
	--CONSTRAINT FK_USERS FOREING KEY(MGR_SEQ) REFERENCES USERS(USER_SEQ)
	--실무에서는 CONSTRAINT FK다 열어놓음.
   ); 
  ...
  CREATE TABLE PARTTIME 
   (	USER_SEQ NUMBER constraint PK_PARTTIME primary key CONSTRAINT FK_PARTTIME_USERSEQ REFERENCES USERS (USER_SEQ),
	--윗문장에서 보면 constraint로 이어서 pk fk를 선언함. 
...
UPDATE ORDERS SET ORDER_DATE = TO_DATE('2019-08-01', 'YYYY-MM-DD') WHERE ORDER_CODE = 'n00001';
UPDATE ORDERS SET ORDER_DATE = TO_DATE('2019-06-21', 'YYYY-MM-DD') WHERE ORDER_CODE = 'n00002';
UPDATE ORDERS SET ORDER_DATE = TO_DATE('2019-06-24', 'YYYY-MM-DD') WHERE ORDER_CODE = 'n00003';
UPDATE ORDERS SET ORDER_DATE = TO_DATE('2019-05-17', 'YYYY-MM-DD') WHERE ORDER_CODE = 'n00004';
UPDATE ORDERS SET ORDER_DATE = TO_DATE('2019-05-13', 'YYYY-MM-DD') WHERE ORDER_CODE = 'n00005';
UPDATE ORDERS SET ORDER_DATE = TO_DATE('2019-05-01', 'YYYY-MM-DD') WHERE ORDER_CODE = 'n00006';
UPDATE ORDERS SET ORDER_DATE = TO_DATE('2019-04-29', 'YYYY-MM-DD') WHERE ORDER_CODE = 'n00007';
UPDATE ORDERS SET ORDER_DATE = TO_DATE('2019-03-16', 'YYYY-MM-DD') WHERE ORDER_CODE = 'n00008';
UPDATE ORDERS SET ORDER_DATE = TO_DATE('2019-02-21', 'YYYY-MM-DD') WHERE ORDER_CODE = 'n00009';
UPDATE ORDERS SET ORDER_DATE = TO_DATE('2019-01-19', 'YYYY-MM-DD') WHERE ORDER_CODE = 'n000010';
UPDATE ORDERS SET ORDER_DATE = TO_DATE('2019-01-04', 'YYYY-MM-DD') WHERE ORDER_CODE = 'n000011';
UPDATE ORDERS SET ORDER_DATE = TO_DATE('2019-12-26', 'YYYY-MM-DD') WHERE ORDER_CODE = 'n000012';
commit;
